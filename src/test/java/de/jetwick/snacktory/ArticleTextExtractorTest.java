...
public class ArticleTextExtractorTest {
    ...
    public void testData1() throws Exception {
        ...
        JResult res = extractor.extractContent(null, readFileAsString("test_data/1.html"));
    ...
    public void testData2() throws Exception {
        ...
        JResult res = extractor.extractContent(null, readFileAsString("test_data/2.html"));
    ...
    public void testData3() throws Exception {
        JResult res = extractor.extractContent(null, readFileAsString("test_data/3.html"));
    ...
    public void testData5() throws Exception {
        JResult res = extractor.extractContent(null, readFileAsString("test_data/5.html"));
...
//        assertTrue(res.getText().endsWith("have beats and bevvies a-plenty. RSVP here.    "));
    ...
    public void testCNN() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("cnn.html")));
    ...
    public void testBBC() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("bbc_noscript.html")));
    ...
    public void testReuters() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("reuters.html")));
    ...
    public void testCaltonCaldwell() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("daltoncaldwell.html")));
    ...
    public void testWordpress() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wordpress.html")));
//        System.out.println("wordpress:" + res.getText());
    ...
    public void testFirefox() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("golem.html")));
...
//        assertEquals("http://www.golem.de/1104/82797-9183-i.png", res.getImageUrl());
    ...
    public void testYomiuri() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("yomiuri.html")));
    ...
    public void testFAZ() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("faz.html")));
//        assertTrue(res.getText(), res.getText().startsWith("Im Gespräch: Umweltaktivist Stewart Brand"));
    ...
    public void testRian() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("rian.html")));
    ...
    public void testJetwick() throws Exception {
        // http://jetwick.com
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("jetwick.html")));
...
//        assertEquals("img/yourkit.png", res.getImageUrl());
    ...
    public void testVimeo() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("vimeo.html")));
...
//        assertEquals("http://b.vimeocdn.com/ts/134/104/134104048_200.jpg", res.getImageUrl());
    ...
    public void testYoutube() throws Exception {
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("youtube.html")));
//        assertTrue(res.getText(), res.getText().startsWith("The makers of doom used remixed version of real metal songs for many"));
    ...
    public void testSpiegel() throws Exception {
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("spiegel.html")));
    ...
    public void testGithub() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("github.html")));
...
//        assertTrue(res.getText(), res.getText().startsWith("ifesdjeen / jReadability Admin Watch Unwatch Fork Where do you want to for"));
    ...
    public void testITunes() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("itunes.html")));
    ...
    public void testTwitpic() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("twitpic.html")));
...
//        assertTrue(res.getText(), res.getText().isEmpty());
    ...
    public void testTwitpic2() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("twitpic2.html")));
...
//        assertEquals("", res.getText());
    ...
    public void testHeise() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("heise.html"))); 
    ...
    public void testTechcrunch() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("techcrunch.html")));
//        System.out.println("techcrunch:" + res.getTitle());        
        assertEquals("http://tctechcrunch.files.wordpress.com/2011/04/screen-shot-2011-04-04-at-12-11-36-pm.png", res.getImageUrl());
    ...
    public void testEngadget() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("engadget.html")));
    ...
    public void testTwitterblog() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("twitter.html")));
...
//        assertEquals("http://4.bp.blogspot.com/-CmXJmr9UAbA/TZy6AsT72fI/AAAAAAAAAAs/aaF5AEzC-e4/s400/Blender_Tsunami.jpg", res.getImageUrl());
    ...
    public void testTazBlog() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("taz.html")));
...
//        assertEquals("http://www.taz.de/uploads/hp_taz_img/full/antiakwprotestjapandapd.20110410-19.jpg", res.getImageUrl());
    ...
    public void testFacebook() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("facebook.html")));
    ...
    public void testFacebook2() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("facebook2.html")));
    ...
    public void testBlogger() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("blogger.html")));
...
//        assertTrue(res.getText(), res.getText().startsWith("Gavin King of Red Hat/Hibernate/Seam fame recently unveiled the top secret project that"));
    ...
    public void testNyt() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("nyt.html")));
    ...
    public void testHuffingtonpost() throws Exception {
        ...
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("huffingtonpost.html")));
    ...
    public void testTechcrunch2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("techcrunch2.html")));
    ...
    public void testCnn2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("cnn2.html")));
    ...
    public void testBusinessweek2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("businessweek2.html")));
    ...
    public void testFoxnews() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("foxnews.html")));
    ...
    public void testStackoverflow() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("stackoverflow.html")));
//        assertTrue("stackoverflow:" + article.getText(), article.getText().startsWith("Hi, Am torn between wicket and vaadin. i am starting a micro-isv"));
    ...
    public void testAolnews() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("aolnews.html")));
    ...
    public void testWallstreetjournal() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wsj.html")));
    ...
    public void testUsatoday() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("usatoday.html")));
    ...
    public void testUsatoday2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("usatoday2.html")));
    ...
    public void testEspn() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("espn.html")));
    ...
    public void testGizmodo() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("gizmodo.html")));
    ...
    public void testEngadget2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("engadget2.html")));
...
//        assertTrue(article.getText(), article.getText().startsWith("Streaming and downloading TV content to mobiles is nice"));
    ...
    public void testWired() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wired.html")));
    ...
    public void tetGigaohm() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("gigaom.html")));
    ...
    public void testMashable() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("mashable.html")));
    ...
    public void testVenturebeat() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("venturebeat.html")));
    ...
    public void testPolitico() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("politico.html")));
    ...
    public void testNinjablog() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("ninjatraderblog.html")));
    ...
    public void testSportsillustrated() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("sportsillustrated.html")));
    ...
    @Test public void testDailybeast() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("thedailybeast.html")));
    ...
    public void testScience() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("sciencemag.html")));
    ...
    public void testSlamMagazine() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("slamonline.html")));
    ...
    public void testEspn3WithFlashVideo() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("espn3.html")));
    ...
    public void testSportingNews() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("sportingnews.html")));
    ...
    public void testFoxSports() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("foxsports.html")));
    ...
    public void testEconomist() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("economist.html")));
    ...
    public void testTheVacationGals() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("thevacationgals.html")));
    ...
    public void testShockYa() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("shockya.html")));
    ...
    public void testWikipedia() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia.html")));
    ...
    public void testWikipedia2() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia_president.html")));
    ...
    public void testWikipedia3() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia_muhammad.html")));
    ...
    public void testWikipedia4() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia_Henne_Strand.html")));
    ...
    public void testWikipedia5() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia_java.html")));
    ...
    public void testWikipedia6() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("wikipedia-knight_rider_de.html")));
    ...
    public void testData4() throws Exception {
        ...
        JResult res = extractor.extractContent(null, readFileAsString("test_data/4.html"));
    ...
    public void testTimemagazine() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("time.html")));
    ...
    public void testCnet() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("cnet.html")));
    ...
    public void testBloomberg() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("bloomberg.html")));
    ...
    public void testTheFrisky() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("thefrisky.html")));
    ...
    public void testBrOnline() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("br-online.html")));
    ...
    public void testGaltimeWhereUrlContainsSpaces() throws Exception {
        ...
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("galtime.com.html")));
    ...
    public void testIssue8() throws Exception {
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("no-hidden.html")));
        assertEquals("This is the text which is shorter but visible", res.getText());
    }

    @Test
    public void testIssue8False() throws Exception {
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("no-hidden2.html")));
    ...
    public void testIssue4() throws Exception {
        JResult res = extractor.extractContent(null, "<html><body><div> aaa<a> bbb </a>ccc</div></body></html>");
        assertEquals("aaa bbb ccc", res.getText());

        res = extractor.extractContent(null, "<html><body><div> aaa <strong>bbb </strong>ccc</div></body></html>");
        assertEquals("aaa bbb ccc", res.getText());
    ...
    public void testI4Online() throws Exception {
        //https://i4online.com
        JResult article = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("i4online.html")));
        ...
        article = extractor2.extractContent(null, c.streamToString(getClass().getResourceAsStream("i4online.html")));
    ...
    public void testImagesList() throws Exception {
        // http://www.reuters.com/article/2012/08/03/us-knightcapital-trading-technology-idUSBRE87203X20120803
        JResult res = extractor.extractContent(null, c.streamToString(getClass().getResourceAsStream("reuters.html")));
        assertEquals(10, res.getImagesCount());
    }
